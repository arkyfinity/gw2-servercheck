    ...
    <div id="app">
        <div class="container">
            ...
            <footer>
                <div class="row xs-justify-center mx-auto">
                    <div class="xs-12">
                        <p>Data from <a href="https://wiki.guildwars2.com/wiki/API:Main">official GW2 API</a>. Source code on <a href="https://github.com/arkyfinity/gw2-servercheck">GitHub</a>.
                            <span @click="modeToggle">
